      ...
      // Loop and play both players moves
		while(true){
         ...
         if (data1.get(1).equals("win") == true){     
            ...
            db.updateQStateValue(db.convertGridtoString(grid1), -1, -1, (float)200.0);
        ...
        if (data2.get(1).equals("win") == true){
                ...
                db.updateQStateValue(db.convertGridtoString(grid2), -1, -1, (float)-200.0);
	             break;
	      }
         ...
         char[][] swappedGrid = db.swapPlayersInGridArray((char[][])data2.get(0));
         db.propogateStateLegalActions(swappedGrid, player1isX);
         
         String player2string = db.convertGridtoString(swappedGrid);
         ArrayList fFunctionResult2 = db.fFunction(player2string);
